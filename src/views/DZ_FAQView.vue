...
const faq = [
    ...
    { q: "Why are there no ingredients such as salt or sugar?", a: "We used to leave salt or sugar 8-9 years ago but we stopped doing it since we had a complaint from one of our guests. But if you need some feel free to ask us."},
    ...
    { q: "Is smoking allowed in the rooms?", a: "No, all our rooms are non-smoking; there are designated smoking areas (on terrace)."},
    ...
    { q: "How do I access the apartment keys?", a: "Key access details will be provided upon check-in. In case of any issues, please contact us."},
    { q: "I have more queastion which are not answered here?", a: "If you have more questions feel free to ask us at draga.zuzic@gmail.com"},
    { q: "", a: ""},
]
</script>
<template>
